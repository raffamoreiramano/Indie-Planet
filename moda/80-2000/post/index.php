        ...
        <article>
            <div class="container">
                ...
                <section class="row mb-5">
                    ...
                    <figure class="col-12 mb-4" align="center">
                        <img class="img-fluid w-50" alt="<?php echo $title." ".$anos['80'][$lang]; ?>" src="<?php echo $corredor; ?>img/xadrezteste.png">
                    </figure>
                </section>
                <section class="row my-5">
                    ...
                    <figure class="col-12 mb-4" align="center">
                        <img class="img-fluid w-50" alt="<?php echo $title." ".$anos['90'][$lang]; ?>" src="<?php echo $corredor; ?>img/xadrezteste.png">
                    </figure>
                </section>
                <section class="row my-5">
                    <div class="col-12">
                    ...
                    <figure class="col-12 mb-4" align="center">
                        <img class="img-fluid w-50" alt="<?php echo $title." ".$anos['2000'][$lang]; ?>" src="<?php echo $corredor; ?>img/xadrezteste.png">
                    </figure>
                </section>
                <section class="row my-5">
                    <div class="col-12">
                    ...
                    <figure class="col-12 mb-4" align="center">
                        <img class="img-fluid w-50" alt="<?php echo $title." ".$anos['agora'][$lang]; ?>" src="<?php echo $corredor; ?>img/xadrezteste.png">
                    </figure>
                </section>
            </div>
        </article>
