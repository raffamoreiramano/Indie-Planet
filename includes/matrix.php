<?php
    ...
    $pastaAtualFim = str_replace(substr($pastaAtual,0,strpos($pastaAtual,' ')),'',$pastaAtual);
    $pastaAtualInicio = str_replace(substr($pastaAtual,strpos($pastaAtual,' '),strlen($pastaAtual)),'',$pastaAtual);
?>