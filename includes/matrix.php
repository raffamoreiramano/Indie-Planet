...
/* Variáveis de string que serão usadas nos menus de navegação para identificar quais conteúdos serão colocados na barra de menu */
    ...
    $topMusica=array(
        1=>array("There Is A Light That Never Goes Out"=>"The Smiths"),
        2=>array("Song 2"=>"Blur"),
        3=>array("Wonderwall"=>"Oasis"),
        4=>array("Last Nite"=>"The Strokes"),
        5=>array("Fluorescent Adolescent"=>"Arctic Monkeys"),
        6=>array("Take Me Out"=>"Franz Ferdinand"),
        7=>array("Seven Nation Army"=>"The White Stripes"),
        8=>array("Mr.Brightside"=>"The Killers"),
        9=>array("When You Were Young"=>"The Killers"),
        10=>array("You Only Live Once"=>"The Strokes")
    );
