...
?>
    ...
    <body class="bg-dark-indie <?php echo $pastaAtual; ?>">
        ...
        <?php
            ...
            $lost=array(
                "en" => "Are you lost, earthling? <span class='h1 text-info'>👽</span> </p>\n<p class='text-light'>Why don't you come with us?",
                "es" => "¿Estás perdido, terrícola? <span class='h1 text-info'>👽</span> </p>\n<p class='text-light'>¿Por qué no vienes con nosotros?",
                "pt" => "Está perdido, terráqueo? <span class='h1 text-info'>👽</span> </p>\n<p class='text-light'>Por que não vem com a gente?"
            );
            $error=array(
                "en" => "ERROR",
                "es" => "ERROR",
        ...
        <article class="container">
            <div class="row m-0">
                ...
                <div class="col 12 col-md-6 py-md-5 alien-box">
                    <a href="../../signin/index.php" class="d-block alien-ship h1 text-info text-center">🛸</a>
                </div>
            </div>
        </article>
        <?php
